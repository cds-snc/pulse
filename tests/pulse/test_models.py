...
class TestReport():
    ...
    @pytest.fixture()
    def report(self, report_date: str) -> typing.Dict[str, typing.Any]:
        return {
            "https" : {
                "eligible" : 29036,
                "uses" : 23788,
    ...
    def test_create_data(self, clean_model, report):
    ...
    def test_create_data_is_latest(self, clean_model, report):
        clean_model.Report.create(report)
        assert clean_model.Report.latest() == report

    def test_report_time(self, report_date: str) -> None:
...
class TestDomain():
    ...
    @pytest.fixture()
    def domain(self) -> typing.Dict[str, typing.Any]:
        return {
    ...
    def test_create(self, clean_model, domain) -> None:
    ...
    def test_add_report(self, clean_model, domain) -> None:
        clean_model.Domain.create(domain)
    ...
    def test_eligible_for_domain(self, clean_model, domain) -> None:
        clean_model.Domain.create(domain)
        clean_model.Domain.create(domain)
    ...
    def test_all(self, clean_model, domain) -> None:
        d1 = domain.copy()
        d2 = domain.copy()
        d1['domain'] = 'test1.test.gc.ca'
        d2['domain'] = 'test2.test.gc.ca'
        clean_model.Domain.create_all([d1, d2])
    ...
    def test_to_csv(self, domain) -> None:
...
class TestAgencies():
    ...
    @pytest.fixture()
    def agency(self) -> typing.Dict[str, typing.Any]:
        return {
    ...
    def test_create(self, clean_model, agency) -> None:
    ...
    def test_not_eligible(self, clean_model, agency) -> None:
    ...
    def test_add_report(self, clean_model, agency) -> None:
        clean_model.Agency.create(agency)
    ...
    def test_find(self, clean_model, agency) -> None:
        clean_model.Agency.create(agency)
    ...
    def test_all(self, clean_model, agency) -> None:
        clean_model.Agency.create(agency)
        clean_model.Agency.create(agency)
